...
public class ver_consolidado_tareas_productivas extends AppCompatActivity {

    private int idOperacion;
    private PieChart pieChart;
    private String[]arrayElemento = new String[]{"Colocando Panel","Colocando llaves","Transportando Panel","Midiendo","Verificando Nivel"};
    private int[]valores = new int[]{33,26,88,100,5};
    private int[]colores = new int[]{Color.BLUE, Color.GREEN, Color.MAGENTA,Color.CYAN,Color.RED};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ver_consolidado_tareas_productivas);

        idOperacion = getIntent().getExtras().getInt("id");

        pieChart = (PieChart)findViewById(R.id.pieTareasProductivas);
        createCharts();
    }
